...
>
    ...
    <div class="mt-auto border-t border-gray-200 p-4">
        <button
            ...
            class="flex w-full items-center justify-center gap-2 rounded-md {isComparing ? 'bg-green-50 text-green-600 hover:bg-green-100' : 'bg-blue-50 text-blue-600 hover:bg-blue-100'} px-4 py-2 text-sm font-medium"
        >
            <div class="h-4 w-4">
                {#if isComparing}
                    <MdCheck />
