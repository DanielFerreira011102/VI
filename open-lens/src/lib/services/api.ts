...
export async function fetchInstitutionsParallel(terms: string[], topicId?: string): Promise<Map<string, Institution | null>> {
...
export async function fetchInstitutionData(term: string, topicId?: string): Promise<Institution | null> {
